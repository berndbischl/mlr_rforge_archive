...
#'    The best \code{n.propose.points} are selected.    
...
#'   Number of points in sequential design generated by Random Latin Hypercube. Only used 
#'   if \code{infill.opt} is 'design'. 
#'   Default is 10000.   
#' @param infill.opt.cmaes.ctrl [\code{list}]\cr 
#'   Control argument for cmaes for single point infill optimization.
#'   Default is empty list.
