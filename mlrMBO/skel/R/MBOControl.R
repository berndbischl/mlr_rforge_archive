...
#'   Default is \code{TRUE}.
#' @param n.init.design.points [\code{integer(1)}]\cr 
...
#'   Default is 1. 
#' @param random.n.points [\code{integer(1)}]\cr 
...
#' @param n.final.evals [\code{integer(1)}]\cr 
...
makeMBOControl = function(y.name="y", minimize=TRUE, noisy=FALSE,
  ...
  n.init.design.points = convertInteger(n.init.design.points)
  checkArg(n.init.design.points, "integer", len=1L, na.ok=FALSE, lower=4L)
  ...
  random.n.points = convertInteger(random.n.points)
  checkArg(random.n.points, "integer", len=1L, na.ok=FALSE, lower=1L) 
  ...
  checkArg(n.final.evals, "integer", len=1L, na.ok=FALSE, lower=0L)
  ...
  structure(list( 
    ...
    silent = silent,
    n.init.design.points = n.init.design.points, 
    ...
    random.n.points = random.n.points, 
    #rank.trafo = rank.trafo,
    final.method = final.method,
    n.final.evals = n.final.evals,
