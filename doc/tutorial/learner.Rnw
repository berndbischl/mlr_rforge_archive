...
* For classification tasks you have to create a Learner_ object if you want to control the type of prediction_ which is returned. Per default you get the class labels when making a prediction_. In order to get posterior probabilities you have to specifiy this when creating the learner.
