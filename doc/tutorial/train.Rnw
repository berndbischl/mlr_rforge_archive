...
it a learner_ and a machine learning task. The classification or
...
The return value is always an object of class Model_ which wraps the
...
## In order to use non-default values of hyperparameters a Learner 
## object has to be created before training.
...
## Used hyperparameters and subset of the data.
l@par.vals
m@learner@par.vals
m@subset
...
## Let's train some Gradient Boosting Machine.
##   On the whole data set.
m <- train("regr.gbm", rt) 
...
##   In order to use non-default values of hyperparameters a Learner object has to be created before training.
...
.. _prediction: _static/rdocs/mlr/train.html
.. _learner: _static/rdocs/mlr/Learner-class.html
.. _Learner: _static/rdocs/mlr/Learner-class.html
.. _Model: _static/rdocs/mlr/Model-class.html

.. |basic_processing| image:: /_images/train-basic_processing.png
          :align: middle
          :width: 700px
          :alt: Flow chart of the mlr processing pipeline
