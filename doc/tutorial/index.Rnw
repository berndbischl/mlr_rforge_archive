...
the package's `manual pages`_. They are regularly updated and reflect the documentation
...
.. _manual pages: http://www.statistik.tu-dortmund.de/~bischl/rdocs/mlr/html/00Index.html
