...
setMethod(
      ...
      par.descs = list(
        ...
        new("par.desc.num", par.name="iter", default=50L, lower=1L),
        new("par.desc.num", par.name="nu", default=0.1, lower=0),
        new("par.desc.num", par.name="bag.frac", default=0.5, lower=0, upper=1),
        new("par.desc.log", par.name="model.coef", default=TRUE),
        new("par.desc.log", par.name="bag.shift", default=FALSE),
        new("par.desc.num", par.name="max.iter", default=20L, lower=1L),
        new("par.desc.num", par.name="delta", default=1e-10, lower=0),
        ...
        new("par.desc.num", par.name="maxdepth", default=30L, lower=1L, upper=30L)
			...
			callNextMethod(.Object, label="ada", pack="ada", desc=desc, par.descs=par.descs)
		}
)
