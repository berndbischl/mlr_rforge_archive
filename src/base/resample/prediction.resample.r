...
#' Generated by \code{\link{resample}}. 
#' Use \code{as.data.frame} to access all information in a convenient format.   
#' Note that the rows are returned in the order defined by
#' the resampling strategy and not in the order present in the
#' dataset. This mainly applies to cross-validation where a different
#' order might be expected.
#'  
#' @exportClass resample.prediction
#' @title Collected predictions of resampling.
