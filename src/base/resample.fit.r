...
#' Optionally you can have a look at the fitted models.
#'
...
#' @param models [logical] \cr If TRUE a list of the fitted models is returned.
...
#' 	   
#'             
#' @return An object of class resample.result [\code{\linkS4class{resample.result}}]
#' 
#' @export
#' 
