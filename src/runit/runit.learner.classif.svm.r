...
test.svm <- function() {
	...
	prob.test  ("classif.ksvm", multiclass.df, multiclass.target, multiclass.train.inds, p2, parset=list(sigma=20, prob.model=T))
	...
	prob.test  ("classif.ksvm",multiclass.df, multiclass.target, multiclass.train.inds, p2, parset=list(kernel="laplacedot", sigma=10, prob.model=T))
	...
	prob.test  ("classif.ksvm", multiclass.df, multiclass.target, multiclass.train.inds, p2, parset=list(kernel="polydot", degree=3, offset=2, scale=1.5, prob.model=T))
