test.fnn.classif <- function() {
  ...
  simple.test.parsets("classif.fnn", multiclass.df, multiclass.target, multiclass.train.inds, old.predicts.list1, parset.list)
  simple.test.parsets("classif.fnn", binaryclass.df, binaryclass.target, binaryclass.train.inds, old.predicts.list2, parset.list)
  ...
  cv.test.parsets("classif.fnn", multiclass.df, multiclass.target, tune.train=tt, tune.predict=tp, parset.list=parset.list)
  cv.test.parsets("classif.fnn", binaryclass.df, binaryclass.target, tune.train=tt, tune.predict=tp, parset.list=parset.list)
}
