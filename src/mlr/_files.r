...
#    "mlr/Parameter_randomVal.R",
    ...
    "mlr/tune/TuneControlGrid.R",
    "mlr/tune/TuneControlOptim.R",
    "mlr/tune/TuneControlCMAES.R",
    "mlr/tune/TuneControlSPO.R",
    "mlr/tune/tune.r",
...
#		"mlr/varsel/varsel.helpers.r",
		"mlr/varsel/novars.r",
    "mlr/varsel/VarselControl.R",
    "mlr/varsel/VarselControlRandom.R",
    "mlr/varsel/VarselControlExhaustive.R",
    "mlr/varsel/VarselControlSequential.R",
