...
#	if (name=="squared") 
#		fun=function(x, task) (x@df$truth - x@df$response)^2 
#	else if (name=="abs") 
#		fun=function(x, task) abs(x@df$truth - x@df$response) 
#	else if (name=="residual") 
#		fun=function(x, task) x@df$truth - x@df$response 
#	else if (name=="zero-one") 
#		fun=function(x, task) as.numeric(x@df$truth != x@df$response) 
#	else if (name=="costs") 
#		fun=function(x, task) { 
#			cm = x@desc["costs"]
#			if (all(dim(cm) == 0))
...
#				cm[truth, pred]
#			}
#			unlist(Map(cc, as.character(x@df$truth), as.character(x@df$response)))			
#		}
#	else 	
